...
#include "lwip/err.h"
#include "lwip/sys.h"
#include "esp_wifi.h" //important for running different protocols in code
...
static const char *TAG = "Reloj Ejemplo";
//Parte de los handles
static EventGroupHandle_t s_wifi_event_group;
    //Esta parte es del wifi
...
#endif
    //Aqui empieza la parte del reloj;
time_t now;
struct tm timeinfo;
...
void configurarfecha(){
    ...
    // Set timezone to Spain Standard Time and print local time
